...
from src.tables import models as _table_models
from src.auth import models as _auth_models
from src.bookings import models as _booking_models
...
config.set_main_option("sqlalchemy.url", build_database_url(settings))
